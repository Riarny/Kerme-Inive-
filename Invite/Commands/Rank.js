module.exports = {
  ...
  run: async ({client, msg, args, inviteMemberData, inviterData, MessageEmbed, moment}) => {
    ...
    const data = await inviteMemberData.findOne({ guildID: msg.guild.id, inviter: member.id });
